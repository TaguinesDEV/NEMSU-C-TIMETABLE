...
CREATE TABLE `subjects` (
    ...
    `meetings_per_week` TINYINT NOT NULL DEFAULT 2,
    `lecture_minutes_per_meeting` INT NOT NULL DEFAULT 0,
    `lab_minutes_per_meeting` INT NOT NULL DEFAULT 0
) ENGINE=InnoDB;
...
CREATE TABLE `subject_instructor_assignments` (
    `subject_id` INT NOT NULL,
